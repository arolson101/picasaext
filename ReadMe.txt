========================================================================
    ACTIVE TEMPLATE LIBRARY : PicasaExt Project Overview
========================================================================

AppWizard has created this PicasaExt project for you to use as the starting point for
...
PicasaExt.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (PicasaExt.h)
        GUID definitions                                (PicasaExt_i.c)
        A type library                                  (PicasaExt.tlb)
        Marshaling code                                 (PicasaExt_p.c and dlldata.c)

PicasaExt.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in PicasaExt.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named PicasaExt.pch and a precompiled types file named StdAfx.obj.
...
PicasaExtps.vcproj
	...
	dlldata.c, PicasaExt_i.c and PicasaExt_p.c which are required
